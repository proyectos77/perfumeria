    ...
    <div class="container" style="position: relative; z-index: 10;">
        <div class="row justify-content-center">
            <div class="col-lg-5 col-xl-4">
                <!-- Badge de Restablecer Contraseña -->
                <div style="text-align: center; margin-bottom: 3rem;">
                    <div style="display: inline-flex; align-items: center; gap: 0.75rem; background: rgba(199, 154, 91, 0.15); border: 1px solid rgba(199, 154, 91, 0.3); border-radius: 50px; padding: 0.75rem 1.5rem; margin-bottom: 2rem;">
                        <i class="bi bi-lock-fill" style="color: #c79a5b; font-size: 1.2rem;"></i>
                        <span style="color: #f4e7df; font-weight: 700; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.1em;">Nueva Contraseña</span>
                    </div>
                </div>
                ...
                <div style="background: rgba(251, 248, 244, 0.97); backdrop-filter: blur(10px); border: 1px solid rgba(199, 154, 91, 0.2); border-radius: 16px; padding: 2.5rem; box-shadow: 0 25px 60px rgba(0, 0, 0, 0.35);">
                    ...
                    <div style="text-align: center; margin-bottom: 2rem;">
                        <h2 style="color: #211b18; font-family: 'Playfair Display', Georgia, serif; font-size: 1.8rem; font-weight: 800; margin-bottom: 0.5rem;">Crear Nueva Contraseña</h2>
                        <p style="color: #75655b; font-size: 0.95rem; margin: 0;">Define una contraseña segura para tu cuenta</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.store') }}">
                        ...
                        <div style="margin-bottom: 1.5rem;">
                            <label for="password" style="display: block; color: #211b18; font-weight: 600; font-size: 0.9rem; margin-bottom: 0.5rem;">
                                <i class="bi bi-lock" style="color: #c79a5b;"></i> Nueva Contraseña
                            </label>
                            <input
                                id="password"
                                type="password"

    ...
    <div class="container py-lg-4">
        ...
        <div class="d-flex flex-column gap-5 mt-5">
            <?php $__currentLoopData = $serviceGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <section id="<?php echo e($group['id']); ?>" class="service-group">
                    <div class="service-group__header">
                        <span class="service-group__eyebrow service-group__eyebrow--<?php echo e($group['accent']); ?>"><?php echo e($group['eyebrow']); ?></span>
                        <h3 class="service-group__title"><?php echo e($group['title']); ?></h3>
                        <p class="service-group__text mb-0"><?php echo e($group['text']); ?></p>
                    </div>

                    <div class="row g-4 mt-1">
                        <?php $__currentLoopData = $group['services']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-6" id="<?php echo e($service['id']); ?>">
                                <article class="service-solution-card h-100">
                                    <div class="service-solution-card__icon service-solution-card__icon--<?php echo e($group['accent']); ?>">
                                        <i class="<?php echo e($service['icon']); ?>"></i>
                                    </div>
                                    <h4 class="service-solution-card__title"><?php echo e($service['title']); ?></h4>

                                    <div class="service-solution-card__block">
                                        <span class="service-solution-card__label">Qué problema resuelve</span>
                                        <p class="mb-0"><?php echo e($service['problem']); ?></p>
                                    </div>

                                    <div class="service-solution-card__block">
                                        <span class="service-solution-card__label">Cómo se aborda</span>
                                        <p class="mb-0"><?php echo e($service['approach']); ?></p>
                                    </div>

                                    <div class="service-solution-card__block">
                                        <span class="service-solution-card__label">Beneficio para el cliente</span>
                                        <p class="mb-0"><?php echo e($service['benefit']); ?></p>
                                    </div>
                                </article>
                            </div>
        ...
        <div class="row g-4 align-items-center">
            ...
            <div class="col-lg-7">
                <div class="work-process-panel">
                    ...
                    <div class="row g-4">
                        <?php $__currentLoopData = $workStages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-6 <?php echo e($loop->last ? 'col-lg-12' : ''); ?>">
                                <article class="work-stage h-100">
                                    <div class="work-stage__step"><?php echo e($stage['step']); ?></div>
                                    <div>
                                        <h4 class="work-stage__title"><?php echo e($stage['title']); ?></h4>
                                        <p class="work-stage__text mb-0"><?php echo e($stage['text']); ?></p>
                                    </div>
                                </article>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<section id="testimonio-form" class="section-surface section-surface--brand py-5">
    <div class="container py-lg-4">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-9">
                <form method="POST" action="<?php echo e(route('testimonios.store')); ?>" class="glass-panel row g-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="rating-stars d-flex justify-content-center gap-2">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <input type="radio" name="calificacion" value="<?php echo e($i); ?>" id="star<?php echo e($i); ?>" required hidden>
                                <label for="star<?php echo e($i); ?>" class="fs-2 star-label">
    ...
    <div class="container py-lg-4 text-center">
        <div class="cta-strip">
            ...
            <div class="d-flex flex-wrap justify-content-center gap-3">
                ...
                <a href="<?php echo e(route('home')); ?>" class="btn btn-outline-light btn-lg px-5 fw-semibold">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Perfumeria\resources\views/servicios.blade.php ENDPATH**/ ?>
<style>
    ...
    .perfume-hero {
        ...
        background:
            ...
            url("<?php echo e(asset('images/logo-pagina.png')); ?>") center right 12% / min(360px, 58vw) no-repeat,
            #2a201c;
        color: #fff;
    }
...
<?php /**PATH C:\laragon\www\Perfumeria\resources\views/catalogo/partials/styles.blade.php ENDPATH**/ ?>
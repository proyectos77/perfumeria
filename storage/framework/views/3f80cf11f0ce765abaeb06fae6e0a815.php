...
<header class="hero-section position-relative overflow-hidden">
    <div class="hero-section__media" aria-hidden="true" style="background-image: url('<?php echo e($siteSettings->assetUrl($heroMedia)); ?>');"></div>
...
<section class="py-5 bg-white" id="problemas">
    <div class="container py-lg-4">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $problemCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-6">
                    <article class="problem-card h-100">
                        <div class="problem-card__icon">
                            <i class="<?php echo e($card['icon']); ?>"></i>
                        </div>
                        <h3 class="problem-card__title"><?php echo e($card['title']); ?></h3>
                        <p class="problem-card__text mb-0"><?php echo e($card['text']); ?></p>
                    </article>
                </div>
...
<section class="py-5 home-services" id="que-hacemos">
    <div class="container py-lg-4">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $serviceBlocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4">
                    <article class="service-pill h-100">
                        <div class="service-pill__icon service-pill__icon--<?php echo e($block['accent']); ?>">
                            <i class="<?php echo e($block['icon']); ?>"></i>
                        </div>
                        <h3 class="service-pill__title"><?php echo e($block['title']); ?></h3>
                        <p class="service-pill__text"><?php echo e($block['text']); ?></p>
                    ...
                    <?php $__currentLoopData = $differentiators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6">
                            <article class="difference-card h-100">
                                ...
                                <h3 class="difference-card__title"><?php echo e($item['title']); ?></h3>
                                <p class="difference-card__text mb-0"><?php echo e($item['text']); ?></p>
                            </article>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    ...
                    <a href="<?php echo e($siteSettings->whatsappUrl()); ?>" target="_blank" class="btn btn-outline-light btn-lg px-5 fw-semibold">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Perfumeria\resources\views/home.blade.php ENDPATH**/ ?>
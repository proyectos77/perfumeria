...
<section id="que-es-crear-system" class="section-surface section-surface--muted py-5">
    <div class="container py-lg-4">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $definitionPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4">
                    <article class="premium-card premium-card--story h-100">
                        ...
                        <h3 class="premium-card__title"><?php echo e($point['title']); ?></h3>
                        <p class="premium-card__text"><?php echo e($point['text']); ?></p>
                    </article>
                </div>
        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-6">
                <div class="image-panel">
                    <img src="<?php echo e($siteSettings->assetUrl($siteSettings->about_feature_image_path)); ?>" alt="Contexto de trabajo de <?php echo e($siteSettings->site_name); ?>" class="img-fluid">
            ...
            <div class="col-lg-6">
                <div class="content-panel">
                    ...
                    <?php $__currentLoopData = $originPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paragraph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p class="section-heading__text text-start mb-3"><?php echo e($paragraph); ?></p>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        </div>
...
<section class="section-surface py-5" id="liderazgo">
    <div class="container py-lg-4">
        ...
        <div class="row g-4 align-items-stretch">
            <div class="col-lg-7">
                <div class="row g-4">
                    <?php $__currentLoopData = $leadershipPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 <?php echo e($loop->last ? 'col-lg-12' : ''); ?>">
                            <article class="leadership-card h-100">
                                <div class="leadership-card__icon">
                                    <i class="<?php echo e($point['icon']); ?>"></i>
                                </div>
                                <h3 class="leadership-card__title"><?php echo e($point['title']); ?></h3>
                                <p class="leadership-card__text mb-0"><?php echo e($point['text']); ?></p>
                            </article>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="col-lg-5">
                <aside class="leadership-panel h-100">
                    <div class="leadership-panel__header">
                        <img src="<?php echo e($siteSettings->assetUrl($siteSettings->about_profile_photo_path)); ?>" class="leadership-panel__avatar" alt="<?php echo e($siteSettings->about_profile_name); ?>">
                        <div>
                            <p class="leadership-panel__eyebrow mb-1">Liderazgo</p>
                            <h3 class="mb-1"><?php echo e($siteSettings->about_profile_name); ?></h3>
...
<section class="py-5" id="en-que-creemos">
    <div class="container py-lg-4">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $beliefs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $belief): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4">
                    <article class="belief-card h-100">
                        <div class="belief-card__icon">
                            <i class="<?php echo e($belief['icon']); ?>"></i>
                        </div>
                        <h3 class="belief-card__title"><?php echo e($belief['title']); ?></h3>
                        <p class="belief-card__text mb-0"><?php echo e($belief['text']); ?></p>
                    </article>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<section class="py-5 position-relative overflow-hidden about-cta">
    <div class="container py-lg-4 text-center position-relative">
        ...
        <a href="<?php echo e(route('contacto')); ?>" class="btn btn-warning btn-lg px-5 fw-bold shadow-lg">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Perfumeria\resources\views/quienessomos.blade.php ENDPATH**/ ?>